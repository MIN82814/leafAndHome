  ...
  const processedPlants = useMemo(() => {
    ...
    const plantArray = Object.entries(myPlants || {}).map(([key, value]) => {
      ...
      return {
        ...
        statusLabel:
          finalScore > 70 ? "良好" : finalScore > 40 ? "需留意" : "急需補充",
        displayDate: new Date(value.purchaseTime * 1000).toLocaleDateString(
          "zh-TW",
        ),
          ...
          <div className="p-4" style={{ maxWidth: "966px", width: "100%" }}>
            <div className="row g-4">
              <div className="col-12">
                ...
                >
                  <span className="me-4 small text-secondary-500 fw-bold">
                    排序
                  </span>
                  ...
                  <div className="card h-100 rounded-2 p-1 ">
                    <div className="card-body p-2">
                      <div className="d-flex justify-content-between align-items-end mb-3 border-bottom border-neutral-700">
                        <h4 className="card-title text-primary-700 mb-0 fw-bold flex-grow-1 me-3 pb-1">
                          {plant.title}
                        </h4>
                        <span className="text-nowrap fw-bold h6 text-neutral-500">
                          第 {plant.daysSincePurchase} 天
                        </span>
                      </div>
                      <div className="row g-0 align-items-center">
                        <div className="col-5 text-center border-end border-light">
                          <h5 className="mb-2 text-nowrap h6">
                            {plant.waterDays <= 0
                              ? "今天需澆水！"
                              : `${plant.waterDays} 天後澆水`}
                          </h5>
                          <h5 className="text-nowrap h6">
                            {plant.fertDays <= 0
                              ? "今天需施肥！"
                              : `${plant.fertDays} 天後施肥`}
                          </h5>
                        ...
                        <div className="col-7 d-flex align-items-start">
                          <div className="flex-grow-1 ps-3 fs-8">
                            {[
                              ...
                              >
                                ...
                                <span
                                  className={`fw-bold text-end ${label === "狀態" && plant.finalScore < 40 ? "text-danger" : "text-neutral-900"}`}
                                >
                                  {val}
                                </span>
                              </div>
                      ...
                      <div className="d-flex gap-2 mt-4 px-1">
                        ...
                        <button
                          className="btn btn-outline-success rounded-pill flex-grow-1 fw-bold py-1 border-2"
                          onClick={() => updatePlantCare(plant.id, "fertilize")}
                        >
                          施 肥
                        </button>
                      </div>
